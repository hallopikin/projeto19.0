...
function setup() {
  ...
  //definir collider (colisor) para mainCyclist (ciclistaPrinci
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    fill('#00FA9A')
    textSize(27)
    text('presione seta para cima para reiniciar', 500, 200)

    path.velocityX = 0
    mainCyclist.velocityY=0
    
    mainCyclist.addAnimation('colidi',mainRacerImg2)
